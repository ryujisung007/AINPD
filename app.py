...
_ALL_HW_TABS = [
    "연구원_페르소나",   # 페르소나 > 연구원 탭
    "마케터_페르소나",   # 페르소나 > 마케터 탭
    "온라인시장분석",    # 시장조사 > 온라인시장분석 탭
    "식품전문정보분석",  # 시장조사 > 식품전문정보분석 탭
    "시장조사학습",      # 시장조사 > 시장조사 데이터학습 탭
    "보고서작성",        # 시장조사 > 보고서작성 탭
    "데이터수집스크립트",# AI데이터수집 > 수집 스크립트 탭
    "데이터학습지시",    # AI데이터수집 > 학습지시 탭
    "배합비",            # 배합비 > 배합비작성 탭
    "배합비_미션",       # 배합비 > 미션수행 탭
    "배합비_프로세스",   # 배합비 > 개발프로세스 탭
    "디지털트윈랩",      # 디지털트윈랩 > Tab1 탭
    "가상소비자모델",    # 디지털트윈랩 > Tab2 탭
    "관능검사",          # 디지털트윈랩 > Tab3 탭
    "프로젝트정리",      # 프로젝트정리 탭
]
